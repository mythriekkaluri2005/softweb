...
" Do You have a problem you can find your solution here."<b></i></pre></div>
    ...
    <div class="bottomdiv">
        <p> Copyrights @2024 and Developed by EKKALURI MYTHRI(212223240034)</p>
</body>
<html>
```
```
...
<body background="backk.png">
    <div class="header">
        ...
        <div class="product">
            <div class="box">
               <b><img src="python.png" width="150" height="50" ></b>
                <h1>PYTHON</h1>
                <p>
            ...
            <div class="box">
                <img src="html photo.jpeg" width="150" height="50">
                <h1>HTML</h1>
                <p>Learn HTML and and how to design web pages in an effective way</p>
            </div>
            <div class="box">
                <img src="Java-programming.png" width="150" height="50">
                <h1>JAVA</h1>
                <p>Learn Java and Concepts such as abstraction,encapsulation,inheritance and polymorphism</p>
        </div>
    </div>
    <div class="bottomdiv">
        <b>Copyrights @2024 and Developed by EKKALURI MYTHRI(212223240034)</b>
    </div>
</body>
</html>
```
...
<body>
    <div class="header">
        ...
        <table class="person">
            <tr>
                <td>
                    <img src="MyPic.jpg" width="100" height="160">
                </td>
		

                <td>
                    <img src="alluarjun.jpg" width="100" height="160">
                </td>
		
                <td>
                   <img src="vijay.jpeg" width="100" height="160">
                </td>
                <td>
                    <img src="virat.jpeg" width="100" height="160" >
                </td>
                <td>
                    <img src="teja.jpeg" width="100" height="160">
                </td>
            </tr>
            <tr>
                <td>
